 ...
 */
public class DeleteStudentModuleTimingCommandParser implements Parser<DeleteStudentModuleTimingCommand> {
     ...
     */
    public DeleteStudentModuleTimingCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(
            ...
            throw new ParseException(
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, DeleteStudentModuleTimingCommand.MESSAGE_USAGE));
        }
        ...
        return new DeleteStudentModuleTimingCommand(index, moduleCode, moduleTiming);
    }
